...
import { SummonerInfoType } from "../../../types/playerTypes";
...
export function SummonerHeader({
    ...
    const updateButtonClick = async () => {
        const button = document.getElementById("updateButton") as HTMLButtonElement;
        ...
        try {
            ...
            localStorage.setItem("lastButtonDisabledTime", Date.now().toString());
        ...
        <div
            ...
            <div className="col-auto">
                <img
                    ...
                    src={`https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/profile-icons/${summonerInfo.iconId}.jpg`}
                    alt="Summoner Icon"
                />
            </div>
            <div className="col truncate">
                <h4 className="truncate">
                    {summonerInfo.name}{" "}
                    <span className="summoner-tag">#{summonerInfo.tag}</span> (
                    {summonerInfo.region})
                </h4>
                <small className="truncate">Level: {summonerInfo.level}</small>
            </div>
            <div className="col-auto">
                <button
                    type="button"
                    ...
                    disabled={loading && timeElapsed === null}>
                    <span>Update</span>
                    <svg
